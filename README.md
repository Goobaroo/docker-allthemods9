...
The docker on first run will download the same version as tagged of `All the Mods 9-0.2.56` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
