...
if ! [[ -f 'Server-Files-1.0.8.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-1.0.8.zip' 'https://edge.forgecdn.net/files/6451/435/Server-Files-1.0.8.zip' || exit 9
	unzip -u -o 'Server-Files-1.0.8.zip' -d /data
