...
if ! [[ -f 'Server-Files-0.2.28.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.28.zip' 'https://edge.forgecdn.net/files/4938/147/Server-Files-0.2.28.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.28.zip' -d /data
