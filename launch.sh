...
if ! [[ -f 'Server-Files-0.2.13.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.13.zip' 'https://edge.forgecdn.net/files/4846/760/Server-Files-0.2.13.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.13.zip' -d /data
