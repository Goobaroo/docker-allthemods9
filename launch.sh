...
if ! [[ -f 'Server-Files-0.0.62.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.62.zip' 'https://edge.forgecdn.net/files/4731/618/Server-Files-0.0.62.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.62.zip' -d /data
