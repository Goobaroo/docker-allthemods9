...
if ! [[ -f 'Server-Files-0.1.7.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.1.7.zip' 'https://edge.forgecdn.net/files/4764/333/Server-Files-0.1.7.zip' || exit 9
	unzip -u -o 'Server-Files-0.1.7.zip' -d /data
