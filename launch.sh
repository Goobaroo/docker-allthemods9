...
if ! [[ -f 'Server-Files-0.2.49.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.49.zip' 'https://edge.forgecdn.net/files/5122/509/Server-Files-0.2.49.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.49.zip' -d /data
