...
if ! [[ -f 'Server-Files-0.2.23.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.23.zip' 'https://edge.forgecdn.net/files/4901/333/Server-Files-0.2.23.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.23.zip' -d /data
