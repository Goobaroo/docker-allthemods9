...
if ! [[ -f 'Server-Files-0.2.21.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.21.zip' 'https://edge.forgecdn.net/files/4885/539/Server-Files-0.2.21.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.21.zip' -d /data
