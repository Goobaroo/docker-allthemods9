...
if ! [[ -f 'Server-Files-0.0.54.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.54.zip' 'https://edge.forgecdn.net/files/4712/918/Server-Files-0.0.54.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.54.zip' -d /data
