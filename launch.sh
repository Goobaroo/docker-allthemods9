...
if ! [[ -f 'Server-Files-0.2.58.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.58.zip' 'https://edge.forgecdn.net/files/5289/530/Server-Files-0.2.58.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.58.zip' -d /data
