...
if ! [[ -f 'Server-Files-0.1.3.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.1.3.zip' 'https://edge.forgecdn.net/files/4756/123/Server-Files-0.1.3.zip' || exit 9
	unzip -u -o 'Server-Files-0.1.3.zip' -d /data
