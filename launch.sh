...
if ! [[ -f 'Server-Files-0.2.11.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.11.zip' 'https://edge.forgecdn.net/files/4830/340/Server-Files-0.2.11.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.11.zip' -d /data
