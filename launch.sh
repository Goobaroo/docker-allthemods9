...
if ! [[ -f 'Server-Files-0.0.55.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.55.zip' 'https://edge.forgecdn.net/files/4715/377/Server-Files-0.0.55.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.55.zip' -d /data
