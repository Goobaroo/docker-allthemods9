...
if ! [[ -f 'Server-Files-0.2.10.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.10.zip' 'https://edge.forgecdn.net/files/4822/361/Server-Files-0.2.10.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.10.zip' -d /data
