...
if ! [[ -f 'Server-Files-0.2.41.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.41.zip' 'https://edge.forgecdn.net/files/5077/423/Server-Files-0.2.41.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.41.zip' -d /data
