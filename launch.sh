...
if ! [[ -f 'Server-Files-0.2.32.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.32.zip' 'https://edge.forgecdn.net/files/4971/982/Server-Files-0.2.32.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.32.zip' -d /data
