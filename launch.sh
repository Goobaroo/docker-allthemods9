...
if ! [[ -f 'Server-Files-1.0.1.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-1.0.1.zip' 'https://edge.forgecdn.net/files/6036/826/Server-Files-1.0.1.zip' || exit 9
	unzip -u -o 'Server-Files-1.0.1.zip' -d /data
