...
if ! [[ -f 'Server-Files-0.2.33.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.33.zip' 'https://edge.forgecdn.net/files/4983/664/Server-Files-0.2.33.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.33.zip' -d /data
