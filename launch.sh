...
if ! [[ -f 'Server-Files-0.2.6.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.6.zip' 'https://edge.forgecdn.net/files/4804/455/Server-Files-0.2.6.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.6.zip' -d /data
