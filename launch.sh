...
if ! [[ -f 'Server-Files-0.2.36.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.36.zip' 'https://edge.forgecdn.net/files/5016/170/Server-Files-0.2.36.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.36.zip' -d /data
