...
if ! [[ -f 'Server-Files-0.0.59.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.59.zip' 'https://edge.forgecdn.net/files/4724/768/Server-Files-0.0.59.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.59.zip' -d /data
