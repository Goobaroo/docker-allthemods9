...
if ! [[ -f 'Server-Files-0.2.40.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.40.zip' 'https://edge.forgecdn.net/files/5069/550/Server-Files-0.2.40.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.40.zip' -d /data
