...
if ! [[ -f 'Server-Files-0.2.0.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.0.zip' 'https://edge.forgecdn.net/files/4792/452/Server-Files-0.2.0.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.0.zip' -d /data
