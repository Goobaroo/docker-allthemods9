...
if ! [[ -f 'Server-Files-0.0.53.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.53.zip' 'https://edge.forgecdn.net/files/4712/450/Server-Files-0.0.53.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.53.zip' -d /data
