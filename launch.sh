...
if ! [[ -f 'Server-Files-0.0.51.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.51.zip' 'https://edge.forgecdn.net/files/4699/351/Server-Files-0.0.51.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.51.zip' -d /data
