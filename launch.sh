...
if ! [[ -f 'Server-Files-0.2.57.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.57.zip' 'https://edge.forgecdn.net/files/5282/304/Server-Files-0.2.57.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.57.zip' -d /data
