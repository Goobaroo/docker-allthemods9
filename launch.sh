...
if ! [[ -f 'Server-Files-0.2.12.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.12.zip' 'https://edge.forgecdn.net/files/4839/100/Server-Files-0.2.12.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.12.zip' -d /data
