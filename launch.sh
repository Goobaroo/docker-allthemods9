...
if ! [[ -f 'Server-Files-0.2.43.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.43.zip' 'https://edge.forgecdn.net/files/5089/680/Server-Files-0.2.43.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.43.zip' -d /data
