...
if ! [[ -f 'Server-Files-0.2.18b.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.18b.zip' 'https://edge.forgecdn.net/files/4861/3/Server-Files-0.2.18b.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.18b.zip' -d /data
