...
if ! [[ -f 'Server-Files-1.0.6.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-1.0.6.zip' 'https://edge.forgecdn.net/files/6319/12/Server-Files-1.0.6.zip' || exit 9
	unzip -u -o 'Server-Files-1.0.6.zip' -d /data
