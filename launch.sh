...
if ! [[ -f 'Server-Files-0.0.57.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.57.zip' 'https://edge.forgecdn.net/files/4723/124/Server-Files-0.0.57.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.57.zip' -d /data
