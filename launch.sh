...
if ! [[ -f 'Server-Files-0.0.56.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.56.zip' 'https://edge.forgecdn.net/files/4718/23/Server-Files-0.0.56.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.56.zip' -d /data
