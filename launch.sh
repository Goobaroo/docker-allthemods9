...
if ! [[ -f 'Server-Files-0.2.50.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.50.zip' 'https://edge.forgecdn.net/files/5124/810/Server-Files-0.2.50.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.50.zip' -d /data
