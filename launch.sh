...
if ! [[ -f 'Server-Files-0.3.3.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.3.3.zip' 'https://edge.forgecdn.net/files/5884/498/Server-Files-0.3.3.zip' || exit 9
	unzip -u -o 'Server-Files-0.3.3.zip' -d /data
