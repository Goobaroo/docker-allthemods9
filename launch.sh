...
if ! [[ -f 'Server-Files-0.2.22.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.22.zip' 'https://edge.forgecdn.net/files/4898/564/Server-Files-0.2.22.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.22.zip' -d /data
