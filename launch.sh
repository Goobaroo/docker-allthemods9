...
if ! [[ -f 'Server-Files-0.2.2.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.2.zip' 'https://edge.forgecdn.net/files/4795/997/Server-Files-0.2.2.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.2.zip' -d /data
