...
if ! [[ -f 'Server-Files-0.1.9.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.1.9.zip' 'https://edge.forgecdn.net/files/4771/948/Server-Files-0.1.9.zip' || exit 9
	unzip -u -o 'Server-Files-0.1.9.zip' -d /data
