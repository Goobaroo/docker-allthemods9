...
if ! [[ -f 'Server-Files-1.0.2.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-1.0.2.zip' 'https://edge.forgecdn.net/files/6038/960/Server-Files-1.0.2.zip' || exit 9
	unzip -u -o 'Server-Files-1.0.2.zip' -d /data
