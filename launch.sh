...
if ! [[ -f 'Server-Files-0.0.63.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.63.zip' 'https://edge.forgecdn.net/files/4733/130/Server-Files-0.0.63.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.63.zip' -d /data
