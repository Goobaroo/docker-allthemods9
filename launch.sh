...
if ! [[ -f 'Server-Files-0.0.58.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.58.zip' 'https://edge.forgecdn.net/files/4723/777/Server-Files-0.0.58.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.58.zip' -d /data
