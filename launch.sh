...
if ! [[ -f 'Server-Files-0.2.48.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.48.zip' 'https://edge.forgecdn.net/files/5113/957/Server-Files-0.2.48.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.48.zip' -d /data
