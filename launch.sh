...
if ! [[ -f 'Server-Files-0.2.4.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.4.zip' 'https://edge.forgecdn.net/files/4799/153/Server-Files-0.2.4.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.4.zip' -d /data
