...
if ! [[ -f 'Server-Files-0.2.8.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.8.zip' 'https://edge.forgecdn.net/files/4815/569/Server-Files-0.2.8.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.8.zip' -d /data
