...
if ! [[ -f 'Server-Files-0.2.53.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.53.zip' 'https://edge.forgecdn.net/files/5189/561/Server-Files-0.2.53.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.53.zip' -d /data
