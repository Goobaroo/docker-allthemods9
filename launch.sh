...
if ! [[ -f 'Server-Files-0.2.27.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.27.zip' 'https://edge.forgecdn.net/files/4931/43/Server-Files-0.2.27.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.27.zip' -d /data
