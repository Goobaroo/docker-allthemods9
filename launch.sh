...
if ! [[ -f 'Server-Files-0.2.18.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.18.zip' 'https://edge.forgecdn.net/files/4860/856/Server-Files-0.2.18.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.18.zip' -d /data
