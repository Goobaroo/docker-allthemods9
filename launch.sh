...
if ! [[ -f 'Server-Files-0.2.47.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.47.zip' 'https://edge.forgecdn.net/files/5111/919/Server-Files-0.2.47.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.47.zip' -d /data
