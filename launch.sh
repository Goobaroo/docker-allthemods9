...
if ! [[ -f 'Server-Files-0.2.16.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.2.16.zip' 'https://edge.forgecdn.net/files/4858/640/Server-Files-0.2.16.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.16.zip' -d /data
