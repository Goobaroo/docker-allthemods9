...
if ! [[ -f 'Server-Files-0.1.5.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.1.5.zip' 'https://edge.forgecdn.net/files/4761/21/Server-Files-0.1.5.zip' || exit 9
	unzip -u -o 'Server-Files-0.1.5.zip' -d /data
