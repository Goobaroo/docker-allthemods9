...
if ! [[ -f 'Server-Files-0.3.1.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.3.1.zip' 'https://edge.forgecdn.net/files/5679/942/Server-Files-0.3.1.zip' || exit 9
	unzip -u -o 'Server-Files-0.3.1.zip' -d /data
