...
if ! [[ -f 'Server-Files-0.2.45.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.45.zip' 'https://edge.forgecdn.net/files/5100/861/Server-Files-0.2.45.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.45.zip' -d /data
