...
if ! [[ -f 'Server-Files-0.1.2.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.1.2.zip' 'https://edge.forgecdn.net/files/4755/774/Server-Files-0.1.2.zip' || exit 9
	unzip -u -o 'Server-Files-0.1.2.zip' -d /data
