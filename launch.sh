...
if ! [[ -f 'Server-Files-0.2.37.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.37.zip' 'https://edge.forgecdn.net/files/5036/871/Server-Files-0.2.37.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.37.zip' -d /data
