...
if ! [[ -f 'Server-Files-0.2.38.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.38.zip' 'https://edge.forgecdn.net/files/5054/588/Server-Files-0.2.38.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.38.zip' -d /data
