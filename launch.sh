...
if ! [[ -f 'Server-Files-0.0.52.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-0.0.52.zip' 'https://edge.forgecdn.net/files/4710/752/Server-Files-0.0.52.zip' || exit 9
	unzip -u -o 'Server-Files-0.0.52.zip' -d /data
