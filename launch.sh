...
if ! [[ -f 'Server-Files-0.2.39.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.39.zip' 'https://edge.forgecdn.net/files/5055/231/Server-Files-0.2.39.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.39.zip' -d /data
