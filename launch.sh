...
if ! [[ -f 'Server-Files-0.2.46.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.46.zip' 'https://edge.forgecdn.net/files/5101/650/Server-Files-0.2.46.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.46.zip' -d /data
