...
if ! [[ -f 'Server-Files-0.3.4.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.3.4.zip' 'https://edge.forgecdn.net/files/5891/385/Server-Files-0.3.4.zip' || exit 9
	unzip -u -o 'Server-Files-0.3.4.zip' -d /data
