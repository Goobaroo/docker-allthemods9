...
if ! [[ -f 'Server-Files-0.2.42.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu Simple.zip forge*
	curl -Lo 'Server-Files-0.2.42.zip' 'https://edge.forgecdn.net/files/5086/130/Server-Files-0.2.42.zip' || exit 9
	unzip -u -o 'Server-Files-0.2.42.zip' -d /data
